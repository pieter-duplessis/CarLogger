...
public class JTextFieldOne extends JTextField {
	...
	public JTextFieldOne(String str) {
		this();
		this.setText(str);
	}

	public JTextFieldOne(int col) {
		this();
		this.setColumns(col);
	}

	public JTextFieldOne(String str, int col) {
		this();
		this.setText(str);
		this.setColumns(col);
	}

	public JTextFieldOne(Document arg0, String arg1, int arg2) {
